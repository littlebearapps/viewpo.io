  ...
  const personas: Persona[] = [
    {
      ...
      painHook: "You pushed to main at 5:25 PM and left the house. The dashboard grid, the settings page, the reporting view — did any of it break? Your PM needs to see the deploy too. You need eyes on it, and so do your stakeholders.",
      bullets: [
        'Push notification arrives — tap to open the exact deploy at 1920px desktop',
        'Send a share link so your PM or designer can verify on their phone too',
    ...
    },
    {
      ...
      painHook: "Every screenshot you share is a brand impression. Your B2B customers are on 1440px laptops — they're evaluating your dashboard, your pricing page, your product UI. Send controlled previews to investors, prospects, and partners. Not a raw deploy URL — a preview they can see at desktop.",
      bullets: [
        'Screenshot your staging build at desktop resolution — right from your phone',
        'Send controlled preview links to investors, B2B prospects, and partners',
        'Professional desktop screenshots for pitch decks and #BuildInPublic posts',
      ],
    ...
    },
    {
      ...
      painHook: "You scaffolded a SaaS dashboard with Bolt. The AI wrote the Tailwind classes. It looks fine on your phone — but your customers sit at 1920px desktops. You need a visual sanity check: does this admin portal, this onboarding flow, this reporting view actually work at desktop?",
      bullets: [
        'Visual sanity check — see what the AI generated at real 1920px desktop on your phone',
        'Verify responsive breakpoints across your SaaS UI without understanding CSS',
    ...
    },
    {
      ...
      painHook: "15 clients. 3 hosting providers. Your phone buzzes at dinner — 'the site looks broken on my laptop.' You can't even see a desktop layout from your phone. Every 'it's fine, actually' reply is a guess.",
      bullets: [
        'One dashboard for every client across Netlify, Vercel, and Cloudflare',
        'Tap a notification, see the exact deploy at 1440px desktop — from your phone',
        'Send a share link so the client sees the same viewport you do',
      ],
      features: ['Multi-Provider', 'Share Links', 'Push Notifications'],
    },
    {
      id: 'agency',
      label: 'Agency',
      role: 'Agency Owner / Project Manager',
      icon: 'building',
      slug: '/use-cases/agencies/',
      accentColour: 'bg-teal-400',
      iconColour: 'text-teal-400',
      painHook: "40 active builds across 3 squads. Client sign-off lives in email threads. Your project managers chase approvals manually — 'did you check the mobile view?' You need a system, not a spreadsheet.",
      bullets: [
        'Workspace per client — every developer, every build, one feed',
        'Controlled share links with viewport lock for client approvals',
        'Approval trail: who saw what, when they approved, at which viewport',
      ],
      features: ['Team Workspaces', 'Share Links', 'Approval Trail'],
    },
    {
      id: 'team-lead',
      label: 'Team Lead',
      ...
      painHook: "The average PR sits 5 days before merge. You review code on your phone — but you can't see the visual result. And your VP just asked 'where's the dashboard redesign?' You need to share upward too, not just review downward.",
      bullets: [
        'Review PRs visually on your phone — see the exact build at Desktop in seconds',
        'Share controlled previews upward to VP, CEO, and senior stakeholders',
    ...
    },
    {
      ...
      painHook: "\"It works on my machine.\" QA needs to verify across resolutions — and not just 9-to-5. When a hotfix deploys at 9pm, the team tags you on the exact deploy and viewport. Tap the notification, verify the fix, approve from your couch.",
      bullets: [
        'Cycle through 6 presets in 10 seconds: Phone S through Desktop',
        'Team tagging — get tagged on specific deploys for instant verification',
