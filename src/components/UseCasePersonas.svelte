<script lang="ts">
  ...
  const personas: Persona[] = [
    ...
    },
    {
      ...
      painHook: "12 clients on 3 providers. But the real chaos isn't finding deploys — it's managing client feedback. Raw preview URLs, confused viewport complaints, 'but you said X' disputes. You need managed previews with controlled feedback and an approval trail.",
      bullets: [
        'One dashboard for every client, every provider — sorted by time',
        'Controlled share links — clients see the right viewport, leave feedback, approve',
        'Preview trail: what was shown, what was said, what was approved',
      ],
