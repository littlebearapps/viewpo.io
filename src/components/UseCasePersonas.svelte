<script lang="ts">
  ...
  const personas: Persona[] = [
    ...
    },
    {
      ...
      painHook: "Momentum is everything in #BuildInPublic. You need to tweet progress daily, but creating desktop screenshots requires a laptop. Miss a day and the algorithm punishes you.",
      bullets: [
        'Screenshot your staging build at desktop resolution — right from your phone',
        'Share directly to Twitter/X via the system share sheet',
